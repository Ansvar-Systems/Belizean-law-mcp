...
MCP server providing access to Belize legislation with full-text search, provision retrieval, and citation validation.
...
- **Source**: [agm.gov.bz](https://agm.gov.bz)
- **Language**: English
- **Jurisdiction**: Belize (BZ)
