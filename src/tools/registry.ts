/**
 * Tool registry for Belize Law MCP Server.
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'Call this FIRST when you need to understand what Belizean legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Belizean statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section/article) from a Belizean statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Belizean legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Belizean statutes simultaneously. ' +
  ...
  },
  {
    ...
    description:
      'Format a Belizean legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Belizean statute or provision is currently in force, amended, or repealed. ' +
