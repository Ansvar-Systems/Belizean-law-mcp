/**
 * Belize Law PDF Parser
 *
 * Parses law text extracted from PDFs downloaded from
 * agm.gov.bz. Uses `pdftotext` (via execFileSync) for extraction,
 * then applies regex-based section parsing.
 *
 * Belize follows English common law (former British Honduras):
 *   "Section 1." / "1." / "1.-(1)"
 *   "PART I", "PART II"
...
export function parseBZLawText(text: string, act: ActIndexEntry): ParsedAct {
...
export function parseBZLawPdf(pdfPath: string, act: ActIndexEntry): ParsedAct {
